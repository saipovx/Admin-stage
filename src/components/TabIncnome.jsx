...
export default function TabIncnome ({ IncomeData, AAccountId , count_documents, handlePageChange , page}) {
  ...
  useEffect(() => {;
    ...
    const loginEndpoint = `/api/management/earn_for_user/${AAccountId}?limit=25`;
